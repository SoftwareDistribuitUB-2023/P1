...
-  Els camps de tipus **string** representen cadenes de bytes codificats en UTF8 (2 bytes) de JAVA acabat amb dos bytes 0 que són un byte en format de xarxa (Big Endian)). 
